...
using namespace muxserver::tmux;

TEST_CASE("unescapeOutput reverses tmux's octal escaping exactly", "[muxserver][gateway]")
{
...
TEST_CASE("guards parse their triple and error flavor", "[muxserver][gateway]")
{
...
TEST_CASE("output notifications unescape and extended output splits the age", "[muxserver][gateway]")
{
...
TEST_CASE("window and session notifications carry their ids", "[muxserver][gateway]")
{
...
TEST_CASE("non-notifications are body; unknown verbs are tolerated", "[muxserver][gateway]")
{
