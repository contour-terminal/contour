...
namespace
{
    ...
    constexpr inline auto stringCaps = defineCapabilities( // {{{
        ...
        string {
            Undefined, "setrgbf"sv, "\033[38:2:%p1%d:%p2%d:%p3%dm"sv }, // setrgbf: Set RGB foreground color
        string {
            Undefined, "setrgbb"sv, "\033[48:2:%p1%d:%p2%d:%p3%dm"sv }, // setrgbb: Set RGB background color
...
bool static_database::booleanCapability(code c) const
{
...
unsigned static_database::numericCapability(code c) const
{
...
string_view static_database::stringCapability(code c) const
{
...
bool static_database::booleanCapability(string_view name) const
{
...
unsigned static_database::numericCapability(string_view name) const
{
...
string_view static_database::stringCapability(string_view name) const
{
...
optional<code> static_database::codeFromName(string_view name) const
{
    for (auto const& cap: numericalCaps)
        if (cap.name == name)
            return cap.code;
...
std::string static_database::terminfo() const
{
