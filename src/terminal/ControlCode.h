...
constexpr std::string_view to_string(C1_7bit code)
{
    ...
    {
        case C1_7bit::SCS_G0:
            return "Set Character Set (0)";
        case C1_7bit::SCS_G1:
            return "Set Character Set (1)";
        case C1_7bit::SCS_G2:
            return "Set Character Set (2)";
        case C1_7bit::SCS_G3:
            return "Set Character Set (3)";
        case C1_7bit::DECSC:
            return "Save Cursor";
        case C1_7bit::DECRC:
        ...
        case C1_7bit::HTS:
            return "Horizontal Tabulation Set";
        case C1_7bit::HTJ:
            return "Horizontal Tabulation with Justification";
        case C1_7bit::VTS:
            return "Vertical Tabulation Set";
        case C1_7bit::PLD:
            return "Partial Line Down";
        case C1_7bit::PLU:
            return "Partial Line Up";
        case C1_7bit::RI:
            return "Reverse Index";
        case C1_7bit::SS2:
            return "Single Shift 2";
        case C1_7bit::SS3:
            return "Single Shift 3";
        case C1_7bit::DCS:
            return "Device Control String";
        case C1_7bit::PU1:
            return "Private Use 1";
        case C1_7bit::PU2:
            return "Private Use 2";
        case C1_7bit::STS:
        ...
        case C1_7bit::SPA:
            return "Start of Protected Area";
        case C1_7bit::EPA:
            return "End of Protected Area";
        case C1_7bit::SOS:
            return "Start of String";
        case C1_7bit::NOT_DEFINED3:
            return "Not Defined (3)";
        case C1_7bit::SCI:
