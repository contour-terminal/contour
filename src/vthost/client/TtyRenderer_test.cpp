...
using vthost::client::renderViewport;
using vthost::client::sgrFor;
...
TEST_CASE("sgrFor selects renditions and colors from a reset", "[vthost][attach]")
{
...
TEST_CASE("sgrFor reproduces the underline variants and rapid blink", "[vthost][attach]")
{
...
TEST_CASE("renderViewport repaints rows, skips wide continuations, places the cursor", "[vthost][attach]")
{
