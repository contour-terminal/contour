...
auto inline const startupLog = core::log::Category("gui.startup", "Logs startup timing information.");
...
auto inline const notifierLog = core::log::Category("gui.notifier", "Desktop notification backend");
...
auto inline const portalLog = core::log::Category("gui.portal", "xdg-desktop-portal method calls");
...
auto inline const launcherLog = core::log::Category("gui.launcher", "Opening URLs in the desktop's handler");
