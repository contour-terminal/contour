...
std::string createForGlobal(Config const& c)
{
    ...
    auto completeOverload = crispy::overloaded {
        ...
        [&](auto name,
            ConfigEntry<std::map<vtbackend::DECMode, bool>, documentation::FrozenDecMode> const& v) {},
        [&](auto name, ConfigEntry<InputMappings, documentation::InputMappings> const& v) {},
        [&](auto name,
            ConfigEntry<std::unordered_map<std::string, TerminalProfile>, documentation::Profiles> const& v) {
        },
        [&](auto name, auto const& v) {},
    };
